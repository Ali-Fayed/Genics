...
class ExploreCollectionViewCell: UICollectionViewCell {
    ...
    func cellData( with model: Repository ) {
        ...
        self.repoOwnerImage.kf.setImage(with: URL(string: repoURL), placeholder: nil, options: [.transition(.fade(0.7))])
        self.repoHeader.kf.setImage(with: URL(string: repoURL), placeholder: nil, options: [.transition(.fade(0.7))])
