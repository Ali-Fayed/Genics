...
class ReposViewModel {
    ...
    func searchRepositories (tableView: UITableView, loadingSpinner: JGProgressHUD, query: String, page: Int) {
...
//    func fetchMoreRepositories (tableView: UITableView, loadingSpinner: JGProgressHUD,query: String, page: Int) {
