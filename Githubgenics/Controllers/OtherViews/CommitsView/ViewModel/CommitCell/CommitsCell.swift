...
class CommitsCell: UITableViewCell {
    ...
    func CellData(with model: Commit) {
        ...
        self.authorAvatar.kf.setImage(with: URL(string: url), placeholder: nil, options: [.transition(.fade(0.7))])
        self.authorAvatar.layer.cornerRadius = UsersCell.profileImageSize.width / 2.0
