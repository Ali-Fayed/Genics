...
class UsersViewModel {
    ...
    func pushWithData (navigationController: UINavigationController) {
        let vc = UIStoryboard.init(name: Storyboards.publicProfileView , bundle: Bundle.main).instantiateViewController(withIdentifier: ID.publicProfileViewControllerID) as? PublicUserProfileViewController
        vc?.viewModel.passedUser = passedUsers
