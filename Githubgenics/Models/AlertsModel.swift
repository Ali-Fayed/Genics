...
class AlertsModel  {
    ...
    static let shared = AlertsModel()

    
    
   //MARK:- List View Alerts
    
    let usersListErrorAlert: UIAlertController = {
      let alert = UIAlertController(title: "", message: "Server limit reached please wait and try again or open VPN".localized(), preferredStyle: .alert)
    ...
    func showUsersListErrorAlert() {
      let RootViewController = UIApplication.shared.windows.first?.rootViewController
        RootViewController?.present(AlertsModel.shared.usersListErrorAlert, animated: true, completion: nil)
    }
    ...
    func showPaginationErrorAlert() {
      let RootViewController = UIApplication.shared.windows.first?.rootViewController
        RootViewController?.present(AlertsModel.shared.userPaginationErrorAlert, animated: true, completion: nil)
    }
    ...
    func showUserRepositoryFetchErrorAlert() {
      let RootViewController = UIApplication.shared.windows.first?.rootViewController
        RootViewController?.present(AlertsModel.shared.userRepositoryFetchErrorAlert, animated: true, completion: nil)
    }
    ...
    let searchUsersErrorAlert: UIAlertController = {
     ...
     func showSearchUsersErrorAlert() {
      let RootViewController = UIApplication.shared.windows.first?.rootViewController
        RootViewController?.present(AlertsModel.shared.searchUsersErrorAlert, animated: true, completion: nil)
    }
   ...
   //MARK:- search repo error
    ...
    func showSearchRepositoriesErrorAlert() {
      let RootViewController = UIApplication.shared.windows.first?.rootViewController
        RootViewController?.present(AlertsModel.shared.searchRepositoriesErrorAlert, animated: true, completion: nil)
    }
